...
public class ParticipantDto {
    ...
    private final PerksDto perksDto;

    private ParticipantDto(@NotNull Builder builder) {
        ...
        this.perksDto = builder.perksDto;
    }
    ...
    public static class Builder{
        ...
        public Builder withperks(PerksDto perksDto){
            this.perksDto = perksDto;
            return Builder.this;
        }
